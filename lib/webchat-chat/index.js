...
router.get('/channel/:cid', function (req, res) {
...
router.post('/channel/:cid/join', function (req, res) {
...
router.get('/channel/:cid/message', function (req, res) {
...
router.post('/channel/:cid/message/post', function (req, res) {
